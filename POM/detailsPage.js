...
//     // Doctor details
//     this.doctorName = page.getByRole('heading');
//     this.speciality = page.locator('text=/Neurology|Psychiatry|Pediatrics/i');
//     this.location = page.locator('text=Clinic');
//     this.availability = page.locator('text=Availability');

//     // Sections
//     this.aboutHeading = page.getByRole('heading', { name: 'About the Doctor' });
//     this.expertiseHeading = page.getByRole('heading', { name: 'Expertise & Services' });

//     // Booking
//     this.bookAppointmentHeading = page.getByRole('heading', { name: 'Book Appointment' });
//     this.selectDate = page.getByText('Select Date');
//     this.nextMonthBtn = page.getByRole('button', { name: 'Go to the Next Month' });
//     this.timeDropdown = page.getByRole('combobox');
//     this.timeOption = page.getByText('10:30 AM');

//     this.addToCartBtn = page.getByRole('button', { name: 'Add to Cart' });

//     // Fee
//     this.consultationFee = page.getByText('Consultation Fee');
//   }
